...
import (
	...
	"github.com/ONLYOFFICE/onlyoffice-gdrive/services/converter/web"
	...
	return &cli.Command{
		...
		Action: func(c *cli.Context) error {
			...
			app := pkg.Bootstrap(
				...
				handler.NewConvertHandler, rpc.NewService, web.NewConverterRPCServer,
				worker.NewConverterWorker,
			)
